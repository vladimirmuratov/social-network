...
export const getWeather = (city) => {
    return axios.get(`https://api.openweathermap.org/data/2.5/weather?q=${city}&units=metric&lang=ru&appid=e25ca3e12aa4d0df30512857462e4ecb`,
...
export const getNews = (category = '') => {
    return axios.get(`https://newsapi.org/v2/top-headlines?country=ru&category=${category}&apiKey=9b56b07b59fb411aa20f516391c5c3ce`,
        {withCredentials: true}).then(res => res.data)
}
